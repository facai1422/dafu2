...
$api = 'https://kaicai.net/api/trial/drawResult?code=xyft&format=json&rows=1';
...
echo '{"sign":true,"msg":"\u6210\u529f","data":[{"title":"168幸运飞艇","name":"txffc","expect":"'.$rq.'","opencode":"'.$hm.'","opentime":"'.str_replace('/','-',$sj).'","source":"开彩采集","sourcecode":""}]}';
