...
$api = 'https://kclm.site/api/trial/drawResult?code=bjk3&format=json&rows=1';
...
echo '{"sign":true,"msg":"\u6210\u529f","data":[{"title":"北京快三","name":"txffc","expect":"'.$rq.'","opencode":"'.$hm.'","opentime":"'.str_replace('/','-',$sj).'","source":"开彩采集","sourcecode":""}]}';
