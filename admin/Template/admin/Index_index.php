...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/">{:GetVar('webtitle')} </a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/">{:GetVar('webtitle')}管理系统</a> <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
	...
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active"><span title="统计概况" data-href="{:U('Tongji/Tongjiweb')}">后台统计描述</span><em></em></li>
			</ul>
		</div>
