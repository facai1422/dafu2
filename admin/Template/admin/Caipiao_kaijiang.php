...
&nbsp;&nbsp;&nbsp;<a href="javascript:;" layer-url="{:U('kaijiangadd')}" title="添加开奖" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加开奖</a>
    ...
    <span style="    margin-left: 200px;">
        <a href="{:U('kai1')}" class="btn btn-success" style="border-radius: 10%;">澳门1</a> | <a href="{:U('kai2')}" class="btn btn-danger" style="border-radius: 10%;">澳门2</a> | <a href="{:U('kai3')}" class="btn btn-primary" style="border-radius: 10%;">澳门3</a>
    </span>
