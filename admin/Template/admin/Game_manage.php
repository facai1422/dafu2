	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
            ...
            <tr class="text-c">
				...
				<td><a style="text-decoration:none" class="ml-5" layer-url="/Game.touzhudanwei.id.{$vo.id}.do" title="修改单位">{$vo.danwei}</a></td>
				{elseif condition="$vo['isdraw'] neq '0'" /}
				<td><a id="is_draw">{$vo.danwei}</a></td>
				{/if}
				
				<td><a style="text-decoration:none" class="ml-5" layer-url="/Game.touzhuedit.id.{$vo.id}.do" title="修改投注号码">{$vo.tzcode}</a></td>
                <td>{$vo.opencode}</td>
