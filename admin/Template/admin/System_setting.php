...
最高金额：<input type="text" class="input-text" name="info[chongzhiMax]" value="{$setlist.chongzhiMax}" style="width:60px;">元&nbsp;&nbsp;
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
打码量：<input type="text" name="info[damaliang]" class="input-text" value="{$setlist.damaliang}" style="width:60px;">%, (打码量=等于充值金额的总数乘以xx％) 例：设置50％ 即玩家充值1000元，则投注额达到500元，不计输赢，即可提现。
<br><br>
