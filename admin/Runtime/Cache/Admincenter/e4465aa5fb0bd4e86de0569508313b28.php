...
<span class="select-box clearfix" style="width:150px; background:#fff; text-align:center; margin:0 auto"><select class="select" onChange="javascipt:window.location.href=this.value">
		...
		<a href="<?php echo U('yukaijianghistory');?>" class="btn radius l" style="margin-left:10px;line-height:1.6em;margin-top:3px">历史开奖</a>
	</div>
	<div class="r">
...
<div class="page-container">
 ...
 $opencodes = array(); $opencodes = explode(',',$vo['opencode']); ?>
					...
					<?php if(($typeid) == "ssc"): ?><div style="margin:0 auto;width:26em;">
						<?php $__FOR_START_997628180__=0;$__FOR_END_997628180__=5;for($i=$__FOR_START_997628180__;$i < $__FOR_END_997628180__;$i+=1){ ?><select id="opencode<?php echo ($i+1); ?>-<?php echo ($vo["expect"]); ?>" style="padding:2px 1px;width:auto;float:left;margin:1px 2px;">
							<option value="">第<?php echo ($i+1); ?>球</option>
							<?php $__FOR_START_1008461585__=0;$__FOR_END_1008461585__=10;for($j=$__FOR_START_1008461585__;$j < $__FOR_END_1008461585__;$j+=1){ ?><option value="<?php echo ($j); ?>" <?php if($opencodes[$i] == $j): ?>selected<?php endif; ?>><?php echo ($j); ?></option><?php } ?>
						</select><?php } ?>
					</div><?php endif; ?>
					<!--11选5-->
					<?php if(($typeid) == "x5"): ?><div style="margin:0 auto;width:26em;">
						<?php $__FOR_START_2084092800__=0;$__FOR_END_2084092800__=5;for($i=$__FOR_START_2084092800__;$i < $__FOR_END_2084092800__;$i+=1){ ?><select id="opencode<?php echo ($i+1); ?>-<?php echo ($vo["expect"]); ?>" style="padding:2px 1px;width:auto;float:left;margin:1px 2px;">
							<option value="">第<?php echo ($i+1); ?>球</option>
							<?php $__FOR_START_1746015416__=0;$__FOR_END_1746015416__=12;for($j=$__FOR_START_1746015416__;$j < $__FOR_END_1746015416__;$j+=1){ if($j<10)$j='0'.$j?>
					...
					<?php if(($typeid) == "pk10"): ?><div style="margin:0 auto;width:40em;">
						<?php $__FOR_START_267790695__=0;$__FOR_END_267790695__=10;for($i=$__FOR_START_267790695__;$i < $__FOR_END_267790695__;$i+=1){ ?><select id="opencode<?php echo ($i+1); ?>-<?php echo ($vo["expect"]); ?>" style="padding:2px 1px;width:40px;float:left;margin:1px 2px;">
							<option value="">第<?php echo ($i+1); ?>球</option>
							<?php $__FOR_START_517463255__=0;$__FOR_END_517463255__=11;for($j=$__FOR_START_517463255__;$j < $__FOR_END_517463255__;$j+=1){ if($j<10)$j='0'.$j?>
								<?php if(($j) != "0"): ?><option value="<?php echo ($j); ?>" <?php if($opencodes[$i] == $j): ?>selected<?php endif; ?>><?php echo ($j); ?></option><?php endif; } ?>
						</select><?php } ?>
					</div><?php endif; ?>
					...
					<?php if(($typeid) == "keno"): ?><div style="margin:0 auto;width:40em;">
						<?php $__FOR_START_552465263__=0;$__FOR_END_552465263__=20;for($i=$__FOR_START_552465263__;$i < $__FOR_END_552465263__;$i+=1){ ?><select id="opencode<?php echo ($i+1); ?>-<?php echo ($vo["expect"]); ?>" style="padding:2px 1px;width:40px;float:left;margin:1px 2px;">
							<option value="">第<?php echo ($i+1); ?>球</option>
							<?php $__FOR_START_1828805711__=0;$__FOR_END_1828805711__=81;for($j=$__FOR_START_1828805711__;$j < $__FOR_END_1828805711__;$j+=1){ if($j<10)$j='0'.$j?>
								<?php if(($j) != "0"): ?><option value="<?php echo ($j); ?>" <?php if($opencodes[$i] == $j): ?>selected<?php endif; ?>><?php echo ($j); ?></option><?php endif; } ?>
						</select>
						<?php if($i==9) echo'<br />'; } ?>
					</div><?php endif; ?>
					...
					<?php if(($typeid) == "k3"): ?><div style="margin:0 auto;width:20em;">
						<?php $__FOR_START_1276076231__=0;$__FOR_END_1276076231__=3;for($i=$__FOR_START_1276076231__;$i < $__FOR_END_1276076231__;$i+=1){ ?><select id="opencode<?php echo ($i+1); ?>-<?php echo ($vo["expect"]); ?>" style="padding:2px 1px;width:auto;float:left;margin:1px 2px;">
							<option value="">第<?php echo ($i+1); ?>球</option>
							<?php $__FOR_START_199239927__=0;$__FOR_END_199239927__=7;for($j=$__FOR_START_199239927__;$j < $__FOR_END_199239927__;$j+=1){ if(($j) != "0"): ?><option value="<?php echo ($j); ?>" <?php if($opencodes[$i] == $j): ?>selected<?php endif; ?>><?php echo ($j); ?></option><?php endif; } ?>
						</select><?php } ?>
					</div><?php endif; ?>
					<!--低频彩-->
					<?php if(($typeid) == "dpc"): ?><div style="margin:0 auto;width:20em;">
						<?php $__FOR_START_736815547__=0;$__FOR_END_736815547__=3;for($i=$__FOR_START_736815547__;$i < $__FOR_END_736815547__;$i+=1){ ?><select id="opencode<?php echo ($i+1); ?>-<?php echo ($vo["expect"]); ?>" style="padding:2px 1px;width:auto;float:left;margin:1px 2px;">
							<option value="">第<?php echo ($i+1); ?>球</option>
							<?php $__FOR_START_544886277__=0;$__FOR_END_544886277__=10;for($j=$__FOR_START_544886277__;$j < $__FOR_END_544886277__;$j+=1){ ?><option value="<?php echo ($j); ?>" <?php if($opencodes[$i] == $j): ?>selected<?php endif; ?>><?php echo ($j); ?></option><?php } ?>
						</select><?php } ?>
					</div><?php endif; ?>
					<!--lhc-->
					<?php if(($typeid) == "lhc"): ?><div style="margin:0 auto;width:40em;">
						<?php $__FOR_START_746185354__=0;$__FOR_END_746185354__=7;for($i=$__FOR_START_746185354__;$i < $__FOR_END_746185354__;$i+=1){ ?><select id="opencode<?php echo ($i+1); ?>-<?php echo ($vo["expect"]); ?>" style="padding:2px 1px;width:40px;float:left;margin:1px 2px;">
							<option value="">第<?php echo ($i+1); ?>球</option>
							<?php $__FOR_START_2088419867__=0;$__FOR_END_2088419867__=50;for($j=$__FOR_START_2088419867__;$j < $__FOR_END_2088419867__;$j+=1){ if($j<10)$j='0'.$j?>
							<?php if(($j) != "0"): ?><option value="<?php echo ($j); ?>" <?php if($opencodes[$i] == $j): ?>selected<?php endif; ?>><?php echo ($j); ?></option><?php endif; } ?>
						</select><?php } ?>
					</div><?php endif; ?>
				</td>
