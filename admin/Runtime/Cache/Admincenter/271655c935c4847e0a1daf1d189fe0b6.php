...
<head>
    ...
    <![endif]-->
    <title><?php echo GetVar('webtitle');?> - 系统管理</title>
</head>
<style type="text/css">
body {background-image: url(assets/bg6.jpg);}
</style>
<body>
...
<div class="loginWraper">
    ...
    <div id="loginform" class="loginBox">
        ...
        <form class="form form-horizontal" action="" method="post">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h4 class="logo"><img src="/assets/logo.png"></h4>
            ...
            <?php if(GetVar('islogincode') == 1): ?><div class="row cl">
                <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe63f;</i></label>
                <div class="formControls col-xs-8">
                    <input id="code" name="info[code]" class="input-text size-L" type="text" placeholder="图像验证码" style="width:175px;">
