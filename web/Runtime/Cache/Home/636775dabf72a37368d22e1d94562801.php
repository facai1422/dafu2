...
<head lang="en">
    ...
    <script language="javascript">
        document.onkeydown = function(event){if ((event.keyCode == 112) || 
...
<div class="" style="display: none; position: absolute;"><div class="aui_outer"><table class="aui_border"><tbody><tr><td class="aui_nw"></td><td class="aui_n"></td><td class="aui_ne"></td></tr><tr><td class="aui_w"></td><td class="aui_c"><div class="aui_inner"><table class="aui_dialog"><tbody><tr><td colspan="2" class="aui_header"><div class="aui_titleBar"><div class="aui_title" style="cursor: move;"></div><a class="aui_close" href="javascript: ;">×</a></div></td></tr><tr><td class="aui_icon" style="display: none;"><div class="aui_iconBg" style="background: none;"></div></td><td class="aui_main" style="width: auto; height: auto;"><div class="aui_content" style="padding: 20px 25px;"></div></td></tr><tr><td colspan="2" class="aui_footer"><div class="aui_buttons" style="display: none;"></div></td></tr></tbody></table></div></td><td class="aui_e"></td></tr><tr><td class="aui_sw"></td><td class="aui_s"></td><td class="aui_se" style="cursor: se-resize;"></td></tr></tbody></table></div></div><!-- 登陆元素 --->
...
<div class="ui-scroll">
    <div class="navFixed ui-wrap">
        ...
        <div class="header_top"><h4 class="logo"><img src="/assets/logo.png"></h4>
            <div class="login">
                ...
                <div class="login_pass user_commom_style">
                    ...
                    <a href="javascript:void(0)" class="two_code">
                        <img  src="<?php echo U('Public/verify',array('imageW'=>120,'imageH'=>45,'fontSize'=>18));?>"  onclick="this.src=this.src+'?temp='+ 1" /></a>
                    <em>
                ...
                <div class="ui-bottom-nav">
                    <a style="padding-right:23px;color:#fff" href="/Public.register.do" target="_blank">用户注册</a>
