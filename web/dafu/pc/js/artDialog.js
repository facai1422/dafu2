...
(function(e, t) {
    ...
    n.fn = n.prototype = {
        ...
        html: function(e) {
            var r = this[0];
            return e === t ? r.innerHTML : (n.cleanData(r.getElementsByTagName("*")),
            r.innerHTML = e,
            this)
        },
        remove: function() {
    ...
    n.fn.init = function(e, t) {
        ...
        if (e.nodeType)
            ...
            this;
        if (e === "body" && t.body)
            return this[0] = t.body,
            this;
        if (e === "head" || e === "html")
            return this[0] = t.getElementsByTagName(e)[0],
            this;
        if (typeof e == "string") {
            r = u.exec(e);
            if (r && r[2])
                return i = t.getElementById(r[2]),
                i && i.parentNode && (this[0] = i),
                this
        }
        return typeof e == "function" ? n(document).ready(e) : (this[0] = e,
        this)
    }
    ,
        ...
        handler: function(t) {
            return function(r) {
                ...
                for (var i = 0, s = t.listeners, o; o = s[i++]; )
                    o.call(t.elem, r) === !1 && (r.preventDefault(),
                    r.stopPropagation())
            }
        },
        fix: function(e) {
    ...
    : document.attachEvent && (s = function() {
        document.readyState === "complete" && (document.detachEvent("onreadystatechange", s),
        n.ready())
    }
    ),
    ...
    n.ajax = function(t) {
        ...
        r.onreadystatechange = function() {
            r.readyState === 4 && r.status === 200 && (t.success && t.success(r.responseText),
    ...
    v.fn = v.prototype = {
        ...
        _init: function(e) {
            var n = this, i, s = e.icon, o = s && (h ? {
                ...
                backgroundImage: "url('" + e.path + "/../images/" + s + ".png')"
            });
            return n.closed = !1,
            n.config = e,
