...
<script type="text/javascript" src="__JS__/protect.js"></script>
<style>
    body {
    display: block;
    margin: 0 auto;
...
* 鼠大大 QQ2551127947
*/
<link rel="stylesheet" type="text/css" href="__CSS__/khdd.css">
...
<div id="container">
    <div id="clockBoard">
        ...
        <input type="hidden" id="khdd" value="{$xin}">
    </div>
</div>
...
<script type="text/javascript">
    window.onload=function(){
        ...
        // 绘制刻度
        var khdd = document.getElementById('khdd').value;
        var total=[350,'较差',550,'中等',600,'良好',650,'优秀',700,'极好',900];
        for(var i=0;i<17;i++){
            if(i%6===3){
                ctx.beginPath();
                ctx.lineWidth='2';
