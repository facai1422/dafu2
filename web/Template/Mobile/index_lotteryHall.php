...
<body>
	<header data-am-widget="header"class="am-header am-header-default header nav_bg am-header-fixed">
	 ...
	 <div data-am-widget="tabs" class="am-tabs am-tabs-default" style="margin: 0;">
      <ul class="am-tabs-nav am-cf" style="background: #FAFAFA;overflow: auto;overflow-y: hidden;">
          ...
          <li class=""><a href="[data-tab-panel-5]">
					...
					<li class=""><a href="[data-tab-panel-6]">
						...
						福彩低频彩</a></li>
		  <li class=""><a href="[data-tab-panel-6]">
				  <i class="iconfont" style="color:#F44336">&#xe65a;</i>
				  香港六合彩</a></li>
      </ul>
				...
				<volist name="cplist" id="cp">
					 <li class="home_main_list">
						<switch name="cp.typeid">
							...
							<case value="ssc">
								<a href="__ROOT__/Game.{$cp.typeid}.code.{$cp.name}.do" >
									<i class="iconfont icon--shishicai" style="color:#4CAF50;"></i>
								</a>
							</case>
							<case value="x5">
								<a href="__ROOT__/Game.{$cp.typeid}.code.{$cp.name}.do">
									<i class="iconfont icon-11xuan5" style="color:#4CAF50;"></i>
								</a>
							</case>
							<case value="keno">
								<a href="__ROOT__/Game.{$cp.typeid}.code.{$cp.name}.do">
            ...
            <ul class="home_main am-avg-sm-3">
				<volist name="cplist2" id="cp">
					<eq name="cp.typeid" value="ssc">
						<li class="home_main_list">
							<a href="__ROOT__/Game.{$cp.typeid}.code.{$cp.name}.do">
								<i class="iconfont icon--shishicai" style="color:#E91E63;"></i>
							</a>
								<h3>{$cp.title}</h3>
								<em>{$cp.ftitle}</em>
						</li>
            ...
            <ul class="home_main am-avg-sm-3">
				<volist name="cplist2" id="cp">
					<eq name="cp.typeid" value="keno">
						<li class="home_main_list">
							<a href="__ROOT__/Game.{$cp.typeid}.code.{$cp.name}.do">
								<i class="iconfont icon-kuaile8" style="color:#009688;"></i>
							</a>
								<h3>{$cp.title}</h3>
								<em>{$cp.ftitle}</em>
						</li>
