...
<header class="bar bar-nav theme-red" style="text-align: center;font-size: 16px;background: linear-gradient(287deg, rgb(101, 149, 222) 0%, rgb(153, 184, 231) 80%, rgb(223, 232, 243) 100%);color: rgb(255, 255, 255);">
