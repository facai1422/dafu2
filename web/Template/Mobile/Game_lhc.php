...
// var x = document.createElement('div'); //是否F12判断跳转
//   Object.defineProperty(x, 'id', {
//       get:function(){
//           // 在这里放入你的代码
//           self.location='mobileBet.html';
//           alert('Telemran：@Lban88');
//       }
//   });
// console.log(x);
...
<script type="text/javascript" src=" /dafu/pc/js/way.min.js"></script>
<script type="text/javascript" src=" /dafu/pc/js/jquery.history.js"></script>
<script type="text/javascript" src=" /dafu/pc/main/common.js"></script>
<script type="text/javascript" src=" /dafu/pc/main/index.js"></script>
<script type="text/javascript" src=" /dafu/pc/js/member.page.js"></script>
<!--<script type="text/javascript" src="/dafu/js/tabGameData.js"></script>-->
<!--<script type="text/javascript" src="/dafu/js/lhc.js"></script>-->
<!--<script type="text/javascript" src="/dafu/js/lhctabGame.js"></script>-->
