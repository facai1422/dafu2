						...
						<ul class="am-list">
							...
							<li class="am-g am-list-item-dated">
								...
								<p class="am-cf billrecord_time" style="font-size:14px">
									...
									<var class="money am-fr" style="color:#3f51b5; font-style:normal;margin-left: 10px;" onClick="getBillInfo('{$vo.trano}')" >查看</var>
									<if condition="$vo.isdraw eq '0'">
									<var class="money am-fr" style="color:#FF9800; font-style:normal" onClick="Order_chedan('{$vo[id]}','{$vo[trano]}',this)" >撤单</var> 
									</if>
...
<ul class="ui-form">
<li style="width:100%; float:left"><label for="question1" class="ui-label">投注彩种：</label><span class="mark" way-data="BillInfo.cptitle">--</span></li>
<li style="width:100%; float:left"><label for="question1" class="ui-label">彩票期号：</label><span class="mark">第 <span way-data="BillInfo.expect" class="mark">--</span> 期</span></li>	
<li style="width:100%; float:left"><label for="question1" class="ui-label">订单玩法：</label><span class="mark" way-data="BillInfo.playtitle">--</span></li>
<li style="width:100%; float:left"><label for="question1" class="ui-label">订单赔率：</label><span way-data="BillInfo.mode" class="mark">--</span></li>	
<li style="width:100%; float:left"><label for="question1" class="ui-label">玩法模式：</label><span way-data="BillInfo.yjf_m" class="mark">--</span></li>	
<li><label for="answer1" class="ui-label">投注号码：</label><span class="mark" way-data="BillInfo.tzcode">--</span></li>	
<li style="width:100%; float:left"><label for="question2" class="ui-label">单注金额：</label><span class="mark" way-data="BillInfo.amount">--</span></li><li style="width:50%; float:left"><label for="question2" class="ui-label">投注注数：</label><span class="mark" way-data="BillInfo.itemcount">--</span></li>
<li style="width:100%; float:left"><label for="question2" class="ui-label">中奖金额：</label><span class="mark" way-data="BillInfo.okamount">--</span></li><li style="width:50%; float:left"><label for="question2" class="ui-label">中奖注数：</label><span class="mark" way-data="BillInfo.okcount">--</span></li>


<li style="width:100%; float:left"><label for="question2" class="ui-label">开奖号码：</label><span class="mark" way-data="BillInfo.opencode">--</span></li><li style="width:50%; float:left"><label for="question2" class="ui-label">中奖状态：</label><span id="BillInfo_isdraw" way-data="BillInfo.state">--</span></li>
</ul>
</div>
</div>
			<!--等待开奖-->
