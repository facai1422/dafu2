...
<div class="main-wrap">
    ...
    <div class="pc4dod-0 jWaGVK">
        <div class="sc-6xd6tf-0 kbDsyl" >
              <form method="post" id="form1" checkby_ruivalidateurl="" action="{:U('Public/logindo')}">
        ...
        <div class="sc-6xd6tf-0 kbDsyl" style="width:89%;">
         ...
         <div class="sc-6xd6tf-0 kbDsyl">
            ...
            <img class="yanzma" id="register-img" src="{:U('Public/verify',array('imageW'=>110,'imageH'=>30))}" onclick="this.src=this.src+'?temp='+ 1">
            <div class="sc-6xd6tf-3 lcWLSi">
            </div>
        </div></form>
        ...
        <div class="pc4dod-1 htdQTn">
            <button class="pc4dod-2 iDBetw">
                <a href="{:U('Public/forgetPaw')}">忘记密码</a></button></div>
        ...
        <div class="sc-1jz5tkq-0 kOylbB">
            <button class="sc-1jz5tkq-1 jGwzAg" >
                <a href="{:U('Public/register')}"style="border: none;outline: none; background-color: transparent; color: rgb(101, 149, 222);">
                立刻注册</button></a>
    ...
    <!--<script>
        var _hmt = _hmt || [];
        if(window.location.host.indexOf('yahu58.com')!=-1){  // 百度统计js for seo
            (function() {
