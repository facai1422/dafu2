...
<body>
	...
	<!--<div id="" class="me-infor" style="padding: 15px;background: #fff;margin-bottom:10px;">-->
	<!--		<div class="infor-xx">-->
	<!--				<ul class="mar-lr20">-->
	...
	<div class="bank_recharge">
		<form method="post" id="bank_recharge_from" action="{:U('Account/recharge')}" >
			...
			<ul class="bank_form_list">
        		<li class="am-cf">
					<span class="bank_form_left am-fl">充值二维码</span>
					<div class="am-fr bank_right_input">
						<img src="{$Allmsg['ewmurl']}"style="    width: 80%;
    height: auto;"/>
					</div>
				</li>
				...
				<li class="am-cf">
					...
					<div class="am-fr bank_right_input">
						<input type="text" name="amount" id="amount" placeholder="最低充值100" class="input_txt">
					</div>
				</li>
				<li class="am-cf">
					<span class="bank_form_left am-fl">微信姓名</span> 
					<div class="am-fr bank_right_input">
						<input type="text" name="payname" class="input_txt" placeholder="微信真实姓名">
					</div>
				</li>
				<li class="am-cf">
