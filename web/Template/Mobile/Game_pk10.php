...
">00</span>
    ...
    /*vertical-align: midd;*/
    border-radius: 1.2vw;
    box-shadow: 1px 1vw 1vw 2px rgba(0,0,0,.1);
            }
        ...
        <div class="cz_openNumb">
            ...
            <div class="open_number">
                ...
                <ol id="ssc_winning_sum">
					<li class="ssc_winning_sum_gif" way-data="showExpect.openCode1" style="background:#ff0000;"></li>
                    <li class="ssc_winning_sum_gif" way-data="showExpect.openCode2" style="background:#C0C0C0;"></li>
                    <li class="ssc_winning_sum_gif" way-data="showExpect.openCode3" style="background:#00FF00;"></li>
                    <li class="ssc_winning_sum_gif" way-data="showExpect.openCode4" style="background:#00FF7F;"></li>
                    <li class="ssc_winning_sum_gif" way-data="showExpect.openCode5" style="background:#FF00FF;"></li>
                    <li class="ssc_winning_sum_gif" way-data="showExpect.openCode6" style="background:#00FFFF;"></li>
                    <li class="ssc_winning_sum_gif" way-data="showExpect.openCode7" style="background:#FFFF00;"></li>
                    <li class="ssc_winning_sum_gif" way-data="showExpect.openCode8" style="background:#000000;"></li>
                    <li class="ssc_winning_sum_gif" way-data="showExpect.openCode9" style="background:#70DB93;"></li>
                    <li class="ssc_winning_sum_gif" way-data="showExpect.openCode10" style="background:#5C3317;"></li>
				        </ol>
    ...
    <section id="gameBet" class="cl">
		<section class="gameBet_balls">
			...
			<if condition="$nowcpinfo['iswh'] eq 0">
				...
				<!--	<ul>-->
				<!--		<li class="on">官方</li>-->
				<!--		<li class="router-link-exact-active">外围</li>-->
				<!--	</ul>-->
...
<script>
  ...
  $(document).on('click','.icon-jiantouxia',function (){
