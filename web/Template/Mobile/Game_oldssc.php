  ...
  <div class="mobileGameTop">
    <header data-am-widget="header"class="am-header am-header-default header nav_bg am-header-fixed" >
      ...
      <div class="am-header-right am-header-nav">
		...
		<ul class="yGame_list" style="width:192px;display:block;">
                ...
                <ol id="ssc_winning_sum">
					...
					<table  style="height: 100%; border: 0px;">
						<tr>
							<td>
								<div class="peilu">
									<var style="color: #FF5722;">赔率</var><span id="amount"></span>
							...
							<td >
								<div class="fandian"><p style="display: inline-block; color: #FF5722;">返点</p> <p  style="display: inline-block;" class="fans">0.0</p>
								</div>	
						</tr>
					</table>
				</div>
    ...
    <section id="gameBet" class="cl">
		<section class="gameBet_balls">
			...
			<if condition="$nowcpinfo['iswh'] eq 0">
				...
				<!--</div>-->
				<!--<span style="text-align: center;cursor: pointer;margin-left: 15px;color: #9C27B0;" id="videoHead" data-class= "show">看直播</span>-->
				<div class="changeBtn">
					<ul>
						<li class="">官方</li>
						<li class="router-link-exact-active on">外围</li>
					</ul>
				</div>
