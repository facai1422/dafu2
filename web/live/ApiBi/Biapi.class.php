...
class Biapi extends JoDES{
	...
	*/
	...
	protected $key='xu9rlod7';                                     //站点秘钥
	
	protected $WebSiteCode='b229633b-9a39-4df5-ae1f-3c7ba24330d9'; //站点code
	 ...
	 public function zzmoney($game,$user,$type,$money)          //用户额度转换  	游戏名	用户名	转入'IN'转出'OUT'	转账金额
	{
		...
		$data="platformCode=".$game.'&userName='.$user.'&transferType='.$type.'&credit='.$money.'&TimeStamp='.time();
		//var_dump($data);
		//die;
